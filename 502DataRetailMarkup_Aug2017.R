...
from_topshelf <- read.csv("~/R/Learning_R_Project/RetailMarkupAug2017Data.csv", header = TRUE) 
...
boxplot(Avg.Markup.With.Tax.Numeric~Category, data=from_topshelf, main="Boxplots by Category - Aug 2017"
        , xlab="Category"
        , ylab="Markup Amt"
        , col="orange"
        , border="black"
